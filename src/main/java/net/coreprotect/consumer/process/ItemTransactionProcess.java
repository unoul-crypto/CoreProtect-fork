            ...
            if (ConfigHandler.loggingItem.get(loggingItemId) != null) {
                ...
                if (current_chest == forceData) {
                    ...
                    if (currentTime > time) {
                        ...
                        ConfigHandler.itemsExternalAdd.remove(loggingItemId);
                        ConfigHandler.itemsExternalRemove.remove(loggingItemId);
