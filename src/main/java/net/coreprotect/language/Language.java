...
public class Language {
    ...
    public static void loadPhrases() {
        ...
        phrases.put(Phrase.HELP_ACTION_2, "Examples: [a:block], [a:+block], [a:-block] [a:click], [a:container], [a:inventory], [a:inventorychange], [a:craft], [a:item], [a:kill], [a:spawn], [a:chat], [a:command], [a:sign], [a:session], [a:username]");
        ...
        phrases.put(Phrase.LOOKUP_INVENTORY_CHANGE, "{0}'s inventory {received|lost} {1} {2} externally.");
