...
public class TabHandler implements TabCompleter {
    ...
    private static final String[] ACTIONS = new String[] { "block", "+block", "-block", "click", "kill", "spawn", "+container", "-container", "container", "chat", "command", "+inventory", "-inventory", "inventory", "inventorychange", "+inventorychange", "-inventorychange", "craft", "+craft", "-craft", "crafted", "usedtocraft", "item", "+item", "-item", "sign", "session", "+session", "-session", "username" };
